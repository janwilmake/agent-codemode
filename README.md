...
[![npm](https://img.shields.io/npm/v/codemode)](https://www.npmjs.com/package/codemode)
[![license](https://img.shields.io/npm/l/codemode)](./LICENSE)
[![node](https://img.shields.io/node/v/codemode)](https://nodejs.org)
...
```bash
npx codemode types --all      # typed TypeScript for every server you're logged into
```
...
```ts
// Generated by codemode from linear's tools/list. Do not edit by hand.
...
| | Cloudflare Code Mode | TanStack AI | Code Mode SDK | **codemode** |
| --- | --- | --- | --- | --- |
